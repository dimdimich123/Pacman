...
public class GhostMovingYellow : MonoBehaviour
{
    ...
    {
        if (_pacman.GridPosition.x == _gridPosition.x && Mathf.Abs(_pacman.GridPosition.y - _gridPosition.y) < 8)
        {
            return true;
        }
        else if (_pacman.GridPosition.y == _gridPosition.y && Mathf.Abs(_pacman.GridPosition.x - _gridPosition.x) < 8)
        {
            return true;
        }
        return false;
